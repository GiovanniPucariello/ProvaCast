...
lang = untypedLiteral.getLang();
	...
	Set<String> result = new HashSet<String>();
	SKOSConcept o1 = (SKOSConcept) o;
	getDataValues( o1, factory.getSKOSPrefLabelProperty(), result, lang );
	getDataValues( o1, factory.getSKOSAltLabelProperty(), result, lang );
	getDataValues( o1, factory.getSKOSHiddenLabelProperty(), result, lang );
	return result;
    }
	...
	Set<String> result = new HashSet<String>();
        SKOSConcept o1 = (SKOSConcept) o;
	getDataValues( o1, factory.getSKOSPrefLabelProperty(), result );
	getDataValues( o1, factory.getSKOSAltLabelProperty(), result );
	getDataValues( o1, factory.getSKOSHiddenLabelProperty(), result );
